<template>
  <GlitchedText text="What is Lorem Ipsum?" :hover="false" />
  ...
  <GlitchedText text="Why do we use it?" :hover="false" />
  ...
  <GlitchedText text="Where does it come from?" :hover="false" />
  ...
  <GlitchedText text="Where can I get some?" :hover="false" />
